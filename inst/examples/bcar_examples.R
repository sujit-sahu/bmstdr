...
M1.leroux <- Bcartime(formula=f1, data=engtotals, scol="spaceid", 
                      ...
                      trials=engtotals$nweek, N=N, burn.in = burn.in, 
                      thin=thin)
summary(M1.leroux)
# BYM model 
...
M3.leroux <- Bcartime(formula=f3, data=engtotals,
                      scol="spaceid",  model="leroux",  
                  family="gaussian", W=Weng,
                      N=N, burn.in = burn.in, thin=thin, 
                  verbose=FALSE)
summary(M3.leroux)
...
M1st_linear <- Bcartime(formula=f1, data=engdeaths, scol="spaceid",
                        tcol="Weeknumber",
                        trials=nweek, W=Weng, model="linear", 
                        family="binomial", 
                        package="CARBayesST", N=N, burn.in=burn.in, 
      thin=thin, verbose=TRUE)
summary(M1st_linear)
M1st_sepspat <- Bcartime(formula=f1, data=engdeaths, scol="spaceid", 
                         tcol="Weeknumber", trials=nweek, W=Weng, 
                         model="sepspatial", 
                         family="binomial", package="CARBayesST", 
                         N=N, burn.in=burn.in, 
                         thin=thin, verbose=FALSE)
summary(M1st_sepspat)
M1st_ar <- Bcartime(formula=f1, data=engdeaths, scol="spaceid", tcol="Weeknumber", 
...
M2st_linear <- Bcartime(formula=f2, data=engdeaths, scol="spaceid", tcol="Weeknumber",  
...
M2st_anova <- Bcartime(formula=f2, data=engdeaths, scol="spaceid", 
      ...
      N=N, burn.in=burn.in, thin=thin, verbose=FALSE)
summary(M2st_anova)
M2st_anova_nointer <- Bcartime(formula=f2, data=engdeaths, 
              scol="spaceid", 
tcol="Weeknumber",  W=Weng, model="anova",interaction=FALSE,  
family="poisson", package="CARBayesST", 
N=N, burn.in=burn.in, thin=thin,  verbose=FALSE)
summary(M2st_anova_nointer)
M2st_sepspat <- Bcartime(formula=f2, data=engdeaths, 
    scol="spaceid", tcol="Weeknumber", W=Weng, model="sepspatial",
...
M2st_ar <- Bcartime(formula=f2, data=engdeaths, scol="spaceid", 
  ...
  package="CARBayesST", N=N, burn.in=burn.in, thin=thin, verbose=FALSE)
summary(M2st_ar)
M2st_ar.v <- Bcartime(formula=f2, data=engdeaths, 
...
M2st_anova.v <- Bcartime(formula=f2, data=engdeaths, scol="spaceid", 
                         tcol="Weeknumber",  W=Weng, model="anova", 
            family="poisson", package="CARBayesST", N=N, burn.in=burn.in,
...
M3st_linear <- Bcartime(formula=f3, data=engdeaths, scol="spaceid", 
                        tcol="Weeknumber", W=Weng, model="linear", 
...
M3st_anova_nointer <- Bcartime(formula=f3, data=engdeaths, 
                               scol="spaceid", tcol="Weeknumber", 
          W=Weng, model="anova", interaction=FALSE, 
                               family="gaussian", 
      package="CARBayesST", N=N, burn.in=burn.in, 
                               thin=thin, verbose=FALSE)
...
M3st_ar <- Bcartime(formula=f3, data=engdeaths, scol="spaceid", 
    tcol="Weeknumber",
                    W=Weng, model="ar", AR=2, family="gaussian", 
  package="CARBayesST" ,
            N=N, burn.in=burn.in, thin=thin, verbose=FALSE)
summary(M3st_ar)
...
\donttest{
  ...
  f1 <-  noofhighweeks ~ jsa + log10(houseprice) + 
  log(popdensity) + sqrt(no2)
  
  M1.inla.bym <- Bcartime(data=engtotals, formula=f1, W=Weng, 
                          scol ="spaceid",  
        model=c("bym"),   package="inla", family="binomial", 
  ...
  f2inla <-  covid ~  jsa + log10(houseprice) + log(popdensity) + sqrt(no2) 
  
  M2.inla.bym <- Bcartime(data=engtotals, formula=f2inla, W=Weng, 
          scol ="spaceid",  offsetcol="logEdeaths", 
                          model=c("bym"),   package="inla",  
  ...
  M3.inla.bym <- Bcartime(data=engtotals, formula=f3, W=Weng, scol ="spaceid",  
                          model=c("bym"),   package="inla", 
              family="gaussian",
                          N=N, burn.in=burn.in, thin=thin) 
  summary(M3.inla.bym)
  ...
  M3.inla.bym.v <- Bcartime(data=engtotals, formula=f3, W=Weng, 
              scol ="spaceid",  
                            model=c("bym"),   package="inla",   
              family="gaussian", 
                            validrows = vs, N=N, burn.in=burn.in, 
              thin=thin) 
  ...
  model <- c("bym", "ar1")
  M1st_inla.bym <- Bcartime(data=engdeaths, formula=f1, W=Weng, 
                  scol ="spaceid", tcol="Weeknumber",  
                            model=model,   trials=nweek, 
                  family="binomial", package="inla", 
                            N=N, burn.in=burn.in, thin=thin) 
  summary(M1st_inla.bym)
 
  M1st_inla_v <- Bcartime(data=engdeaths, formula=f1, W=Weng, 
              scol = "spaceid", tcol="Weeknumber",  
                          offsetcol="logEdeaths",  model=model, 
              trials=nweek,  family="binomial", 
                          package="inla", validrow=vs, N=N,
  ...
  model <- c("bym")
  M1st_inla.bym.none <- Bcartime(data=engdeaths, formula=f1, W=Weng, 
                scol ="spaceid", tcol="Weeknumber",  
                                 model=model,   trials=nweek, 
                family="binomial", package="inla", 
                                 N=N, burn.in=burn.in, thin=thin) 
  ...
  model <- c("bym", "ar1")
  M3inla.bym.ar1 <- Bcartime(data=engdeaths, formula=f3, W=Weng, 
          scol ="spaceid", tcol="Weeknumber",  
                             model=model,  family="gaussian", 
      package="inla", validrows = vs, 
      N=N, burn.in=burn.in, thin=thin) 
