...
```{r temporaleffects, echo=TRUE, eval=TRUE, message=FALSE, fig.cap="Temporal effects  of wind spped from model M7"}
b <- out$betatp
tn <- nrow(b)
itmax <- ncol(b)
tids <- 1:tn 
...
table4.2 <- structure(c(4.98035204433472, 244.848615156094, 247.231802193936, 
...
```{r obsvpredplot, echo=FALSE, eval=TRUE, fig.cap="Predictions with 95% limits against observations for two models: AR (2) on the left panel and INLA on the right panel", fig.width = 400/72, fig.height = 400/80}
