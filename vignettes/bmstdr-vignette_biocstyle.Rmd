...
```{r valid3sites, echo=TRUE, eval=TRUE, fig.height=8, fig.cap="Time series of observed and predicted values at three sites."}
...
ar2valid <- b$pwithseg
```
```{r obsvpredplot, echo=FALSE, eval=TRUE, fig.width=8, fig.cap="Predictions with 95% limits against observations for two models: AR (2) on the left panel and INLA on the right panel."}
library(ggpubr)
